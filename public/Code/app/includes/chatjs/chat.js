...
function createChatBox(chatboxtitle,chatheaderimg,status,minimizeChatBox) {
    ...
    $("<div />" ).attr("id","chatbox_"+chatboxtitle)
        ...
        .html('<div class="chatbox-icon" onclick="javascript:toggleChatBoxGrowth(\''+chatboxtitle+'\')" href="javascript:void(0)"><div class="contact-floating red"><img class="chat-image img-circle pull-left" src="storage/user_image/'+chatheaderimg+'"><small class="unread-msg">2</small><small class="status Online"></small></div></div>' +
        '<div class="panel personal-chat"> ' +
        '<div class="panel-heading chatboxhead"> ' +
        '<div class="panel-title">' +
        '<img class="chat-image img-circle pull-left" height="36" width="36" src="storage/user_image/'+chatheaderimg+'" alt="avatar-image"> ' +
