<template>
  <div class="mx-2 mt-0 notifications-popup">
    <v-menu
      ...
      nudge-right="25"
      z-index="301"
      content-class="tokbox-notifications my-menu height-100-50"
    ...
    >
      <template v-slot:activator="{ on }">
        <a v-on="on" style="position: relative;">
          ...
          <p :class="['model-mobile-header-text', (menu_opened == true) ? 'text-grey' : 'text-light-grey']">Notifications</p>
      ...
      <v-card width="375" style="border-radius: 5px !important;" class="height-100">
        <v-list class="px-5 height-100" style="background-color: #F9F9F9;" :style="[all_notifications.length > 4 ? {'overflow-y': 'auto','height': '77vh'} :{}]">
          <v-list-item class="py-0 " dense>
            <v-list-item-title class="header_notifications mb-5 mt-5 d-sm-block"></v-list-item-title>
          </v-list-item>
              ...
              if (path == 'icon_notification') {
                ...
                if (this.all_notifications.length > 0) {
                  if (this.menu_opened) {
                    ...
                    this.$emit('active-menu', {notification: true});
                    return window.location.origin+"/images/model-dashboard/notification-bell-active.png";
                  } else if (this.color == 'white') {
                    return window.location.origin+"/images/icons/notification-on.svg"
                  }
                  this.$emit('active-menu', {notification: false});
                  return window.location.origin+"/images/model-dashboard/notification-bell.png"
                } else {
                  if (this.menu_opened) {
                    if (this.color == 'black') {
                      this.$emit('active-menu', {notification: true});
                      return window.location.origin+"/images/model-dashboard/notification-active.png"
                    }
                    return window.location.origin+"/images/icons/w-notification.png"
                  } else if (this.color == 'white') {
                  ...
                  this.$emit('active-menu', {notification: false});
                  return window.location.origin+"/images/model-dashboard/header-notification.png"
                }
                //     <!-- <img v-if="text_chat_notifications" src="images/icons/Bell_Notification.svg" />
                //  <img v-else src="images/icons/Bell_Inactive_white.svg" />
                // </div>
...
.my-menu::before {
  ...
  border-bottom: 13px solid #f0f0f7;
}
