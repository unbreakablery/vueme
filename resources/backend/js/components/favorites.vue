                ...
                <div class="py-3">
                  <v-row class="m-0">
                    ...
                    <v-card-title class="justify_between d-flex p-0">
                      ...
                      <div class="btn-set" >
                        <v-btn id="follow"  outlined color="#f77f98" rounded>Following</v-btn>
                        <v-btn id="unfollow"  outlined @click="saveFavorite(item)" color="#949498" rounded>Unfollow</v-btn>
                      </div>
                    </v-card-title>
                  </v-row>
                </div>
