                    ...
                    <v-container>
                        <v-row>
                            <v-col class="col-5 col-md-8 col-lg-9">
                                <div class="font-weight-bold text-dark" style="font-size:20px" >Fan Insight</div>
                                <br><br>
                            </v-col>
                        </v-row>
                        <v-row>
                        ...
                        <v-data-table
                            ...
                            <template v-slot:item="{item}">
                              <tr :key="item.id" style="height:40px">
                                ...
                                <td class="px-0">
                                    <div class="d-inline float-right">${{item.credit | numFormat("0,0.00")}}</div>
                                </td>
                              </tr>
                            </template>
                          </v-data-table>
    ...
    computed:{
        ...
        methods: {
            ...
            f_get_data_oveview: function() {
                ...
                axios.get('/api/v1/user/analytics/stream?months='+this.selected_month, {
                })
                .then(response => {
