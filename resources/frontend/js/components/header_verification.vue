            ...
            <nav class="navbar navbar-expand-lg ml-0 w-100">
              ...
              <li v-if="!guest" class="mobile-menu">
                <div class="d-inline-flex mobile-menu">
                  <div>
                    <credits v-if="user.role_id===2" :user="user" style="color:rgb(162, 162, 162) !important"/>
                  </div>
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav w-100 mr-auto">
                  ...
                  <li v-if="!guest" class="nav-item feed-menu"><a href="/myfeed" :class="['nav-link', (url == 'myfeed') ? 'active' : '']">My Feed</a></li>
                  <li class="nav-item model-menu"><a href="/models" :class="['nav-link', (url == 'models') ? 'active' : '']">Models</a></li>
                  <li class="nav-item categroy-menu"><a href="/categories" :class="['nav-link', (url == 'categories') ? 'active' : '']">Categories</a></li>
                  <li class="nav-item explore-menu"><a href="/explore" :class="['nav-link', (url == 'explore') ? 'active' : '']">Explore</a></li>
                  -->
                ...
                <!-- <ul v-if="guest && redeem == 'true'"  class="navbar-nav mr-auto right-menu">
                </ul> -->
                      ...
                      <v-list-item-group color="primary">
                          ...
                          <v-list-item-content>
                              ...
                              <v-list-item-group color="primary">
                                  ...
                                  <v-list-item-content>
                                      <v-list-item-title style="color:black !important">Log Out</v-list-item-title>
                                  </v-list-item-content>
                                  </v-list-item>
                              </v-list-item-group>
                              </v-list>
                    ...
                    <div v-if="step == 1">
                      ...
                      <div class="form-row justify-content-center mb-0 mt-5">
                        ...
                        <a style="color: #8EbEF8; font-size: 12px !important;color:#1F1E34 !important;font-weight: 400;line-height:18pt;" target="_blank"
                          href="javascript:void(0)"
                        >Already a member?</a>
                        <span class="text-danger" style="margin-left:10px;font-size: 12px !important; font-weight: 600; font-family: 'Montserrat', sans-serif!important; color:#F77F98 !important;  line-height:18pt;"
                          :loading="loading"
                          :disabled="loading"
                          @click="login()"
                        >Login Here</span>
