              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <v-list dense class v-if="!guest && user.role_id===1 && $vuetify.breakpoint.smAndDown">
                      <v-list-item-group color="primary">
                          <v-list-item dense class="px-5" href="/dashboard/profile/1">
                            <v-list-item-icon>
                ...
                <ul v-else class="navbar-nav w-100 mr-auto d-flex justify-end">
                  ...
                  <li v-if="!$vuetify.breakpoint.smAndDown || guest" class="nav-item how-menu" style="flex-grow: 1;"><a href="/how-it-works" :class="['nav-link']">How It Works</a></li>
                        ...
                        <div class="col-md-12 col-12 col-sm-12 col-lg-12 mb-0 mt-0">
                          <div class="form-row m-0">
                            <div class="col-md-12 col-12 col-sm-12 col-lg-12 pl-0 pr-0">
                              ...
                              <label style="width: 88%;font-size: 9px !important;color:#1F1E34 !important;font-weight: 400;line-height:18pt;">
                ...
                <div class="card-body px-0 pt-8">
                  <form method="POST" action class="registration_form">
                    <div class="form-row mb-5 justify-content-center">
                      <div class="form-row m-0">
                        <div
                        style="font-size:24px;color:#131220;font-weight: 600; text-align: center;"
                    ...
                    <div class="form-row mb-0">
                      ...
                      <div class="col-md-12 col-12 col-sm-12 col-lg-12 mb-5">
                       ...
                       <span  v-if="errors1.password" class="float-right text-danger small">{{ errors1.password[0] }}</span>
                      </div>
                    </div>
                    <div class="d-flex justify-content-between">
                        <ul style="padding-left: 15px;" class="mb-0">
                    ...
                    <div class="form-row mb-0">
                      ...
                      <div class="col-md-12 col-12 col-sm-12 col-lg-12 mb-5">
                       ...
                       <span  v-if="errors1.password_confirmation" class="float-right text-danger small">{{ errors1.password_confirmation[0] }}</span>
