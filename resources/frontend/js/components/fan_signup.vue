<template>
  <div>
      ...
      >
        <v-card style="background:#fff !important;border-radius:6px !important ">
                  ...
                  <form method="POST" action class="registration_form">
                    ...
                    <div v-if="step == 2">
                      ...
                      <div class="form-row mb-0">
                        ...
                        <div class="d-flex col-md-12 col-xs-12 col-sm-12 col-lg-12 mb-4">
                    ...
                    <div v-if="step == 3">
                      ...
                      <div class="form-row justify-content-between px-4 mb-0 mt-0">
                        <a  class="btn-action-outline" style="padding: 10px 56px;"
                          href="javascript:void(0)"
                          :loading="loading"
                          :disabled="loading"
                    ...
                    <div v-if="step == 5">
                        ...
                        <div class="d-flex justify-content-center">
                          <ul style="padding: 0px 15px;" class="mb-0 text-center">
                            ...
                            <li class="required-text-step-2" style="color:#6c757d !important;">
                              Code Sent to: <span style="color: #9759FF;">+14144144141</span>
                            </li>
                          </ul>
                        </div>
                      </div>
                      ...
                      <div class="d-flex justify-content-center">
                        <ul style="padding: 0px 15px;" class="mb-4 text-center">
                          <li class="required-text-step-2" style="color:#6c757d !important;">
                            Didn’t receive your code?  <a style="color: #9759FF;">Resend</a>
                          </li>
                        </ul>
                      </div>
                      <div class="form-row justify-content-center px-4 mb-0 mt-0">
      ...
      <!-- Fan Signup Section -->
      <v-card style="background: #F1F1F1; box-shadow: none !important;">
        <v-card-text class="p-0">
          <div class="row m-0">
            <div class="col-12 px-3">
              <div class="card-body px-0 pt-8">
                <form method="POST" action class="registration_form">
                  <div class="form-row mb-3 align-items-start">
                    <div class="row col-md-5 col-xs-12 col-sm-12 col-lg-5 px-0">
                      <label
                        class="col-md-12 col-xs-12 col-sm-12 col-lg-12 control-label pl-4 pr-0" style="font-size:12px!important;color:#131220!important"
                      >
                        Email <span class="text-danger" style="font-size:14px;">*</span>
                    ...
                    <div :class="['row col-md-7 col-xs-12 col-sm-12 col-lg-7 px-0', (mobile) ? 'pxt-15' : '']">
                      <div class="w-50 plr-15">
                        <label
                          class="col-md-12 col-xs-12 col-sm-12 col-lg-12 control-label pl-0 pr-0"
                          style="font-size:12px!important;color:#131220!important"
                        >
                          Country Code <span class="text-danger" style="font-size:14px;">*</span>
                        </label>
                        <div class="col-md-12 col-12 col-sm-12 col-lg-12 px-0">
                          <v-select
                  ...
                  <div class="form-row justify-content-center mb-0 mt-5 pt-5" style="border-top: 1px solid rgb(160 160 165);margin: 0px 10px;">
                    <div :class="['col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12', (mobile) ? 'text-center' : '']">
                      <a style="color: #8EbEF8; font-size: 12px !important;color:#1F1E34 !important;font-weight: 500;line-height:18pt; padding-top:10px;" target="_self"
                        href="javascript:void(0)"
                      >Already a member?</a>
                      <span class="text-danger" style="color: #F77F98 !important;margin-left:10px;font-size: 12px !important;font-weight: 600;line-height:18pt; padding-top:10px;cursor: pointer;"
                        :loading="loading"
                        :disabled="loading"
                        @click.prevent="userSignupDialog=false;loginDialog=true;"
                      >Login Here</span>
                    ...
                    <div :class="['col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12', (mobile) ? 'text-center' : '']">
                      <a style="color: #8EbEF8; font-size: 12px !important;color:#1F1E34 !important;font-weight: 500;line-height:18pt;" target="_self"
                        href="javascript:void(0)"
                      >Are you model?</a>
                      <span class="text-danger" style="color: #F77F98 !important;margin-left:10px;font-size: 12px !important;font-weight: 600;line-height:18pt;cursor: pointer;"
                        :loading="loading"
                        :disabled="loading"
                        @click.prevent="signupDialog=false;signupDialog=true;"
                      >Apply Now</span>
                    </div>
                  </div>
                </form>
  ...
  watch: {
    newuser1: {
      handler: function(val) {
        let c_pwd = val.password_confirmation;
        let pwd = val.password;
        
        this.p_validate.at_least_6_chars = (pwd.length >= 6) ? true : false;        
        this.c_p_validate.at_least_6_chars = (c_pwd.length >= 6) ? true : false;
      },
      deep: true
    }
  },
...
.header .right-menu li a.signup-btn
{
	font-size:12px;
	color:#FFF;
...
.header .right-menu li a.signup-btn:hover
{
