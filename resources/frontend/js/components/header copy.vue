  ...
  <div>
    <div class="landing">
          ...
          <div class="row">
            <nav class="navbar navbar-expand-lg ml-0 w-100">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <v-list dense class v-if="!guest && user.role_id===1 && $vuetify.breakpoint.smAndDown">
                      <v-list-item-group color="primary">
                          ...
                          <v-list-item dense class="px-5" href="/dashboard/reviews">
                          <v-list-item-icon>
                ...
                <ul v-else class="navbar-nav w-100 mr-auto d-flex justify-end">
                  ...
                  <li v-if="!guest" class="nav-item mobile-menu"><a href="/dashboard/reviews" :class="['nav-link']"><img src="/images/icons/reviews.svg" /> Reviews</a></li>-->
                  ...
                  <li v-if="!guest" class="nav-item feed-menu  hidden-sm-and-down"><a href="/myfeed" :class="['nav-link', (url == 'myfeed') ? 'active' : '']">My Feed</a></li>
                  <li v-if="!guest" class="nav-item model-menu hidden-sm-and-down"><a href="/models" :class="['nav-link', (url == 'models') ? 'active' : '']">Models</a></li>
                  <li v-if="!guest" class="nav-item categroy-menu  hidden-sm-and-down"><a href="/categories" :class="['nav-link', (url == 'categories') ? 'active' : '']">Categories</a></li>
                  <li v-if="!guest" class="nav-item explore-menu hidden-sm-and-down"><a href="/explore" :class="['nav-link', (url == 'explore') ? 'active' : '']">Explore</a></li>
                  ...
                  <li>
                    <div class="d-inline-flex">
                        ...
                        >
                          ...
                          <v-list-item dense class="px-5" :href="'/'+user.userProfile.profile_link">
                            <v-list-item-icon>
                                <img src="/images/model-dashboard/eye.svg" />
                            </v-list-item-icon>
                            <v-list-item-content>
                          ...
                          <v-list-item-content>
                              ...
                              <v-list-item-group color="primary">
                                <v-list-item class="px-5" href="/dashboard/user/profile">
                                  ...
                                  <v-list-item class="px-5" :href="'/' + user.userProfile.profile_link">
                                  <v-list-item-icon>
                                  ...
                                  <v-list-item-content>
                                      <v-list-item-title>Replays</v-list-item-title>
                                  </v-list-item-content>
                                  </v-list-item>
                                  ...
                                  <v-list-item class="px-5" href="https://respectfully.zendesk.com/hc/en-us"  target="_blank">
                                  <v-list-item-icon>
      ...
      <v-dialog
        ...
        width="375"
        :content-class="(step == 4 || step == 5) ? ' top-modal full-screen-modal' : ' full-screen-modal'"
        persistent
        style="max-height:unset;height:100%;margin:0;"
      >
                ...
                <div class="card-body px-0 pt-4">
                  <form method="POST" action class="registration_form">
                    <div v-if="step == 1">
                      ...
                      <div class="form-row justify-content-center mb-2 mt-0">
                      <span class="text-danger" style="font-size:12px;">
                        <span v-if="errors && errors[0] && typeof errors[0] === 'string'">Something went wrong. Please try again.</span>
                      </span>
                      </div>
                      ...
                      <div class="form-row justify-content-center mb-0 mt-5">
                        ...
                        <a style="cursor:default; color: #8EbEF8; font-size: 12px !important;color:#1F1E34 !important;font-weight: 400;line-height:18pt;" target="_blank"
                          
                        >Already a member?</a>
                        <span class="text-danger" style="cursor: pointer; margin-left:10px;font-size: 12px !important;font-weight: 600; font-family: 'Montserrat', sans-serif!important; color: #F77F98 !important;  line-height:18pt;"
                          :loading="loading"
                          :disabled="loading"
                          @click.prevent="loginDialog=true;userSignupDialog=false;signupDialog=false"
                        >Login Here</span>
                      </div>
                    </div> 
                    <div v-if="step == 2">
                      ...
                      <div class="form-row mb-0">
                        <v-row>
                          <v-col cols="6">
                        <label style="font-size:12px!important;color:#131220!important">
                        ...
                        <v-row>
                          <v-col cols="6">
                            ...
                            <template
                              slot="selection"
                              slot-scope="data"
                            ><span :style=" !$vuetify.breakpoint.xsOnly ? 'font-size:14px!important;color: rgba(0, 0, 0, 0.87)!important;' : 'font-size:12px!important;color: rgba(0, 0, 0, 0.87)!important;'">{{data.item.code2}} (+ {{data.item.prefix}} )</span></template>
                            <template
                              slot="item"
                              slot-scope="data"
                        ...
                        <div class="d-flex justify-content-between mt-n3" style="padding-top:10px">
                      ...
                      <div class="form-row mb-5">
                        ...
                        <div class="row py-2 px-3">
                             <span
                             v-if="errors.faceFile"
                             class="float-left text-danger"
                            >{{ errors.faceFile[0] }}</span
                            >
                        </div>
                      </div>
                      <div class="form-row justify-content-center mb-2 mt-0">
                      <span class="text-danger" style="font-size:12px;">
                        <span v-if="errors && errors[0] && typeof errors[0] === 'string'">Something went wrong. Please try again.</span>
                        <span v-else-if="errors.Age">{{errors.Age[0]}}</span>
                        <span v-else-if="errors.governmentIssuedFile	">{{errors.governmentIssuedFile[0]}}</span>
                      </span>
                      </div>
                      <div class="form-row justify-content-center mb-0 mt-0">
                        <v-btn  class="btn-action" style="margin-bottom:30px !important;" 
                          :loading="loading"
                          :disabled="loading"
                          @click="step2()"
                        >
                    ...
                    <div class="row mt-3" v-else-if="missingDataMessage !== ''">
                    <div class="col-12 text-center">
                     <span class="float-left text-danger">We were unable to get the following data:<br/><font style="font-weight:500;">{{missingDataMessage}}</font><br/> Please upload a better picture of your ID.</span>
                    </div>
                    </div>
                      <div class="form-row justify-content-between px-0 mt-2" style="margin-bottom:30px !important;">
                        <div class="col-md-6">
                        ...
                        <v-btn class="btn-action" style="padding: 10px;width:100%;"
                          ...
                          :disabled="loadingConfirm || confirmError || missingDataMessage !== ''"
                          @click="sendConfirm"
                          >
                          Confirm
                        </v-btn>
                    ...
                    <div v-if="step == 4">
                      ...
                      <div class="form-row justify-content-center px-4 mb-0 mt-0">
                        <v-btn  class="btn-action" style="padding: 10px 50px;margin-bottom:30px !important;"
                          :loading="loading"
                          :disabled="loading"
                          @click="step++"
                        >
                    ...
                    <div v-if="step == 5">
                      <div class="form-row mb-5 justify-content-center">
                        ...
                        <div class="d-flex justify-content-center">
                          <ul style="padding: 0px 15px;" class="mb-0 text-center">
                            <li class="required-text-step-2" style="font-weight:600;">
                      ...
                      <div class="d-flex justify-content-center">
                        <div class="col-md-10 col-xs-10 col-sm-10 col-lg-10 mb-5 ">
                          <v-text-field
                            ...
                            <span class="text-danger" style="font-size:12px;">
                            <span  v-if="errors.code">{{ errors.code[0] }}</span>
                            </span>
                        </div>
                      </div>
                      <div class="d-flex justify-content-center">
                      ...
                      <div class="form-row justify-content-center px-4 mb-0 mt-0">
                        <v-btn class="btn-action" style="padding: 10px 50px;margin-bottom:30px;"
                          :loading="loading"
                          :disabled="loading"
                          @click="verifyCode()"
                        >
      ...
      <v-dialog v-model="userSignupDialog" width="375" content-class="full-screen-modal">
        <v-card style="background:#FFFFFF;border-radius:6px!important ">
                    ...
                    <div class="form-row mb-0">
                      ...
                      <div class="col-md-12 col-12 col-sm-12 col-lg-12 mb-5">
                        ...
                        >
                                          ...
                                          <v-row>
                                <div class="my-helper  col-xs-12 col-sm-6 col-md-6">
                                  <small
                                    style="font-size: 11px !important"
                                    :style="[
                                      newuser1.password
                                        ? newuser1.password.match(regexChar)
                                          ? { color: '#2CC05F' }
                                          : errors.password
                                          ? { color: '#DB4242' }
                                          : { color: '#97999D' }
                                ...
                                <div class="my-helper  col-xs-12 col-sm-6 col-md-6">
                                  <small
                                    ...
                                    :style="[
                                      newuser1.password
                                        ? newuser1.password.match(regexUpper)
                                          ? { color: '#2CC05F' }
                                          : errors.password
                                          ? { color: '#DB4242' }
                                          : { color: '#97999D' }
                                ...
                                <div class="my-helper  col-xs-12 col-sm-6 col-md-6">
                                  <small
                                    ...
                                    :style="[
                                      newuser1.password
                                        ? newuser1.password.match(regexSix)
                                          ? { color: '#2CC05F' }
                                          : errors.password
                                          ? { color: '#DB4242' }
                                          : { color: '#97999D' }
                                ...
                                <div class="my-helper  col-xs-12 col-sm-6 col-md-6">
                                  <small
                                    ...
                                    :style="[
                                      newuser1.password
                                        ? newuser1.password.match(regexNumber)
                                          ? { color: '#2CC05F' }
                                          : errors.password
                                          ? { color: '#DB4242' }
                                          : { color: '#97999D' }
          ...
          <span
            v-if="errors['errors1.password']"
            class="float-left text-danger small"
            >{{ errors["errors1.password"][0] }}</span
          >
                        ...
                        >
                                ...
                                <div class="my-helper  col-xs-12 col-sm-6 col-md-6">
                                  <small
                                    style="font-size: 11px !important"
                                    :style="[
                                      newuser1.password_confirmation
                                        ? newuser1.password_confirmation.match(regexChar)
                                          ? { color: '#2CC05F' }
                                          : errors.password
                                          ? { color: '#DB4242' }
                                          : { color: '#97999D' }
                                ...
                                <div class="my-helper  col-xs-12 col-sm-6 col-md-6">
                                  <small
                                    ...
                                    :style="[
                                      newuser1.password_confirmation
                                        ? newuser1.password_confirmation.match(regexUpper)
                                          ? { color: '#2CC05F' }
                                          : errors.password
                                          ? { color: '#DB4242' }
                                          : { color: '#97999D' }
                                ...
                                <div class="my-helper  col-xs-12 col-sm-6 col-md-6">
                                  <small
                                    ...
                                    :style="[
                                      newuser1.password_confirmation
                                        ? newuser1.password_confirmation.match(regexSix)
                                          ? { color: '#2CC05F' }
                                          : errors.password
                                          ? { color: '#DB4242' }
                                          : { color: '#97999D' }
                                ...
                                <div class="my-helper  col-xs-12 col-sm-6 col-md-6">
                                  <small
                                    ...
                                    :style="[
                                      newuser1.password_confirmation
                                        ? newuser1.password_confirmation.match(regexNumber)
                                          ? { color: '#2CC05F' }
                                          : errors.password
                                          ? { color: '#DB4242' }
                                          : { color: '#97999D' }
          ...
          <span
            v-if="errors['errors1.password_confirmation']"
            class="float-left text-danger small"
            >{{ errors["errors1.password_confirmation"][0] }}</span
          >
                      </div>
                    </div>
                    ...
                    <div class="form-row justify-content-center mb-0 mt-5" style="border-top: 1px solid rgb(160 160 165);margin: 0px 10px;">
                      ...
                      <a style="cursor:default; color: #8EbEF8; font-size: 12px !important;color:#1F1E34 !important;font-weight: 500;line-height:18pt; padding-top:10px;" target="_blank"
                        
                      >Already a member?</a>
                      <span class="text-danger" style=" cursor: pointer; color: #F77F98 !important;margin-left:10px;font-size: 12px !important;font-weight: 600;line-height:18pt; padding-top:10px;"
                        :loading="loading"
                        :disabled="loading"
                    ...
                    <div class="form-row justify-content-center mb-0" >
                      ...
                      <a style="cursor:default; color: #8EbEF8; font-size: 12px !important;color:#1F1E34 !important;font-weight: 500;line-height:18pt;" target="_blank"
                        
                      >Are you a model?</a>
                      <span class="text-danger" style=" cursor: pointer; color: #F77F98 !important;margin-left:10px;font-size: 12px !important;font-weight: 600;line-height:18pt;"
                        :loading="loading"
                        :disabled="loading"
                        @click.prevent="signupDialog=true;userSignupDialog=false;loginDialog=false;"
                      >Apply Now</span>
                    </div>
                ...
                <div class="card-body p-0 p-lg-5 pt-4">
                  <form method="POST" action class="registration_form  pt-0 pb-0">
                    ...
                    <div class="form-row justify-content-center mb-0 mt-5" style="border-top: 1px solid rgb(160 160 165);margin: 0px 10px;">
                      ...
                      <span style="cursor: pointer; color: #F77F98;margin-left:10px;font-size: 12px !important;font-weight: 600;line-height:18pt;padding-top:10px;"
                        :loading="loading"
                        :disabled="loading"
                        @click.prevent="userSignupDialog=true;loginDialog=false;"
                      >Sign Up Here</span>
                    </div>
                    <div class="form-row justify-content-center mb-10">
                      ...
                      >Are you a model?</a>
                      <span style="cursor: pointer; color: #F77F98;margin-left:10px;font-size: 12px !important;font-weight: 600;line-height:18pt;"
                        :loading="loading"
                        :disabled="loading"
                        @click.prevent="signupDialog=true;userSignupDialog=false;loginDialog=false;"
                      >Apply Now</span>
...
import RequestPrivate from "./request_private";

export default {
  components: { RequestPrivate },
  props: [
    "user",
    "guest",
    "abilities",
  ...
  created(){
    ...
    if(this.user && this.signupDialog != true  && this.user.role_id == 1){
      if(!this.user.userProfile.license_checked){
         axios
            .post('generic/list', {table: 'category', fields: ['id', 'name','deleted_at']})
            .then(response => {
               function checkDeleted(cat)  {
                  return cat.deleted_at==null;
                }
                this.categories = response.data.data.filter(checkDeleted);
                this.step = 2;
                this.signupDialog = true;
              })
      }
      else if(!this.user.userMobile.validated){
        this.step = 4;
        this.signupDialog = true;
      }
    }
  ...
  methods: {
     verifyCode() {
      ...
      axios
        .post("/user/verify/phone/code_after", input)
        .then((response) => {
          if (response.status === 200) {
            this.redirect = response.data.role == 1 ? "/dashboard/profile" : "/explore";
    ...
    resendCode() {
      axios
        .post("/user/resend/phone/code_after")
        .then((response) => {
    ...
    validateLicense(){
      ...
      for(var i = 0;i < requiredFields.length; i++){
        if(this.license[requiredFields[i]] == null)
          this.missingDataMessage += this.missingDataMessage !== "" ? ", " + requiredFieldsTags[i] : requiredFieldsTags[i]; 
      }
        this.isAllData = this.missingDataMessage === "";
    },
    ...
    step1() {
      ...
      axios
        ...
        .catch((error) => {
          if (typeof error.response.data === "object") {
            this.errors = error.response.data.errors ? error.response.data.errors : error.response.data.message ? error.response.data.message : ["Something went wrong. Please try again."];
          } else {
            this.errors = ["Something went wrong. Please try again."];
          }
          this.show1 = false;
...
.my-menu .v-item-group .v-list-item {
  padding: 0!important;
}
