            ...
            <tr>
                <td style="padding: 20px 0; text-align: center">
                    <h1
                        ...
                        Respectfully Daily Report</h1>
                </td>
            </tr>
            <!-- Email Header : END -->
            <tr>
                <td style="background-color: #ffffff;">
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="1000px">
                        <tr>
                            <td class="with_mobile_img padding_0" style="padding: 20 0;ont-family: 'Montserrat', 
