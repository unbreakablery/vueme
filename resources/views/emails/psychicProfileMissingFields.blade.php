    ...
    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="750"
      ...
      <tr>
        <td
          ...
          <!--[if !gte mso 9]> -->
            <a style="font-weight: 600; display: inline-block; margin-top: 20px; margin-bottom: 30px;padding: 10px 20px; background-color: #9759FF; border-radius: 20px; color:white; font-size: 14px;font-family: 'Montserrat', 'Verdana', sans-serif;"
              href="{{config('app.url')}}/dashboard/profile" target="blank">
              Finish Now
            </a>
          <!--<![endif]-->
          <!--[if gte mso 9]>
                 <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{config('app.url')}}/dashboard/profile" style="height:38px;v-text-anchor:middle;width:120px;" arcsize="60%" opacity="0" stroke="f" fillcolor="#9759FF">
                  <w:anchorlock/>
