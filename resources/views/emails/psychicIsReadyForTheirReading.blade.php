                ...
                <td style="background-color: #ffffff;">
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                            ...
                            <h4 style="display: inline;">  <p style="display: table-cell;color: #9daff9;    font-size: 15px;">{{$appointment->psychic()->first()->UserProfile()->first()->name}}</p>
                                        ...
                                        <table style="margin-top: 40px !important;"
                                            ...
                                            <tr>
                                                <td dir="ltr" valign="top"
                                                 ...
                                                 href="{{config('app.url')}}/dashboard/appointments" target="blank">Begin Reading</a>
                                                <!--<![endif]-->  
                                                <!--[if gte mso 9]>
                                                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{config('app.url')}}/dashboard/appointments" style="height:38px;v-text-anchor:middle;width:152px;" arcsize="60%" opacity="0" stroke="f" fillcolor="#9daff9">
                                                <w:anchorlock/>
