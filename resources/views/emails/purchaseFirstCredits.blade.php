...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; ">
  <center role="article" aria-roledescription="email" lang="en" style="width: 100%;">
    ...
    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600"
      ...
      <tr>
        <td
          style="background: #FFFFFF;text-align: center; color: #A162C1;width: 100%; max-width: 600px; font-family: sans-serif; font-size: 15px; line-height: 15px; margin: auto; display: block;">
          <!--[if !gte mso 9]> -->
          <img src="{{config('app.url')}}/images/site-images/logo_color.png" width="130"
            style="margin-top: 30px" />
          <!--<![endif]-->
          <div
            style="padding: 0px 20px; line-height: 40px; padding-top: 85px; text-align: center; margin: 0 0 10px; font-family: 'Montserrat', 'Verdana', sans-serif; font-size: 25px; font-weight: normal;">
            Inner Strength <br>Starts with a Reading
          </div>
          <div
            ...
            We're so happy you're here! Get trusted advice whenever and wherever you need it. Just add a little love to your digital wallet and you'll have your Model in your back pocket!
          </div>
        </td>
      </tr>
      <tr>
        <td style="text-align: center; background-color: #F0F7FF; padding-bottom: 50px">
          <img src="{{config('app.url')}}/images/icons/email/9874.png" style="max-width: 100%;margin-top: 40px;margin-bottom: 40px" />

          <div>
            <!--[if !gte mso 9]> -->
            <a style="padding: 11px 80px; background-color: #8EBEF8; border-radius: 20px; color:white; font-size: 25px;font-family: 'Montserrat', 'Verdana', sans-serif;"
            ...
            <!--[if gte mso 9]>
              <table width="100%"><tr height="40"></tr></table>
                 <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{config('app.url')}}" style="height:52px;v-text-anchor:middle;width:275px;" arcsize="40%" opacity="0" stroke="f" fillcolor="#8EBEF8">
                  <w:anchorlock/>
      ...
      <tr>
        <td style="height: 8px; background-color: #8EBEF8">
        </td>
      </tr>
      <!-- 3 Even Columns : END -->
      ...
      <tr>
        <td dir="ltr" width="100%" style="padding: 10px; background-color: #9759FF;">
