  ...
  <center role="article" aria-roledescription="email" lang="en" style="width: 100%;">
    ...
    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="750"
      ...
      <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" 
        ...
        <v:fill type="tile" src="{{config('app.url')}}/images/site-images/10_day_abilities_triggered_email.png" color="#333333" />   
      ...
      <![endif]-->
        <td class="padding-sm"
          ...
          background-size: cover; background-repeat: no-repeat; position: relative; background-position: center; background-image: url('{{config('app.url')}}/images/site-images/10_day_abilities_triggered_email.png')">
          <!--[if gte mso 9]>
        <table width="100%">
         <tr height="50"></tr>
        </table>
      ...
      <tr>
        <td
          ...
          <div
            ...
            <div style="font-family: 'Montserrat', 'Verdana', sans-serif;">Trusting Your Gut Ain’t Easy</div>
          </div>
        </td>
      </tr>
      <tr>
        <td
          style=" background:#43425D;text-align: center; color: #FFFFFF;font-family: 'Montserrat',  'Verdana', sans-serif; font-size: 15px; margin: auto; display: block; padding-bottom: 20px;padding-top: 20px">
          ...
          <div
            ...
            <div style="font-family: 'Montserrat', 'Verdana', sans-serif;">Need a crash course in finding your intuition? Tapping into your inner compass takes practice, patience
              and forgiveness. But you’re in luck, we’ve got 2,000 Spiritual Advisors with powerful abilities to show
              you the way.</div>
          </div>
        </td>
      </tr>
      <tr>
        <td
          style="line-height: 26px; background:#F0F0F7;text-align: center; color: #43425D;font-family: 'Montserrat',  'Verdana', sans-serif; font-size: 14px; margin: auto; display: block; padding-top: 20px">

          <div
            style="text-transform: capitalize; margin:auto; text-align: center; font-family: 'Montserrat', 'Verdana', sans-serif; font-size: 16px; color:#43425D; font-weight: 600; text-align: center;max-width: 550px;">
            Not Sure Where to Start?
          </div>
          <div
            style="text-transform: capitalize; margin:auto; text-align: center; font-family: 'Montserrat', 'Verdana', sans-serif; font-size: 16px; color:#43425D; font-weight: 600; text-align: center;max-width: 550px;">
            Check Out Our Most Popular Advisors
          </div>
        </td>
      </tr>
