...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; ">
  <center role="article" aria-roledescription="email" lang="en" style="width: 100%;">
    ...
    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="750"
      ...
      <tr>
        <td
          style="background: #ffffff;text-align: center; color: #43425e;width: 100%; max-width: 750px; font-family: 'Montserrat', 'Verdana', sans-serif;  font-size: 15px; line-height: 15px; margin: auto; display: block;">
          <!--[if !gte mso 9]> -->
          <a href="{{config('app.url')}}">
            <img src="{{config('app.url')}}/images/site-images/logo_black.png" width="159" style="margin-top: 30px" />
          </a>
          <!--<![endif]-->
          <div
            style="font-weight: 600; padding: 0px 20px; line-height: 40px; padding-top: 20px; text-align: center; margin: 0 0 0px;  font-family: 'Montserrat', 'Verdana', sans-serif; font-size: 18px;">
            {{$user->userProfile->name}}, It’s Been A While…
          </div>
          <div
            style="font-weight: normal; line-height: 24px; text-align: center; padding:30px 20px; padding-top: 15px; margin: auto; font-family: 'Montserrat', 'Verdana', sans-serif;font-size: 16px;max-width: 450px;">
            We’re not afraid to say it, we miss you! A lot has happened since you last visited - now you have even more
            top rated Models to choose from. Log in and see who’s new!
          </div>
        </td>
        <!--[if gte mso 9]>    
            <tr height="25"></tr>
      ...
      <tr>
        <td height="60" style="background: #43425e;text-align: center; height: 60px;">
          <div style="color:#FFFFFF;font-size:16px;font-weight:600; font-family: 'Montserrat', 'Verdana', sans-serif;">
            Our Featured Model Picks</div>
        </td>
      </tr>
      <tr>
        <td style="height: 16px;background:#F0F0F7;">
        </td>
      </tr>
              ...
              background-size: cover; border-radius: 50%; display: inline; display: inline-block"></div>
                ...
                <div style="font-size: 12px; text-align: right; color: white;">
                  ...
                  <a style="font-weight: 600; display: inline-block; padding: 10px 20px; padding-right: 5px; background-color: #8EBEF8; border-radius: 20px; color:white; font-size: 12px; font-family: 'Montserrat',  'Verdana', sans-serif;"
                    ...
                    <span style="font-family: 'Montserrat', 'Verdana', sans-serif;">Profile</span> <img
                      style="padding: 0px 8px;" src="{{config('app.url')}}/images/site-images/top_rate_email.png" />
                  </a>
                  <!--<![endif]-->
                  <!--[if gte mso 9]>
            ...
            <table cellspacing="0" width="100%">
              ...
              <tr>
                <td
                  ...
                  Check out our <a
                    style=" color: #8EBEF8;font-family: 'Montserrat',  'Verdana', sans-serif;text-align:center"
