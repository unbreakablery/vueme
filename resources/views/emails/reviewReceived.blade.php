...
<body width="100%"
    ...
    <![endif]-->
                        ...
                        <tr>
                            <td
                                ...
                                <h2
                                    ...
                                    Hi {{$user->userProfile()->first()->display_name}},</h2>
                                <p style="margin: 0 0 10px;font-family: 'Montserrat', 'Verdana', sans-serif; text-align: center;">
                                        Looks like your spiritual guidance made an impression. 
                                        Add a public reply to get even more from your reviews. </p>
                                            ...
                                            <table style="margin-top: 40px !important;"
                                                ...
                                                <tr>
                                                    <td dir="ltr" valign="top"
                                                        style="width: 37%; font-family: 'Montserrat', 'Verdana', sans-serif; font-size: 15px; color:white;      text-align: right; padding-right: 25px; "
                                                  ...
                                                  <!--[if !gte mso 9]> -->
                                                        <a >
                                                                ...
                                                                "  src="https://respectfully-dev-assets.s3.us-west-2.amazonaws.com/user-profile/314/91873bb6a0516bcdc35004460002e3bf.jpg"> 
                                                        </a>
                                                        <!--<![endif]-->  
                                                          <!--[if gte mso 9]>
                                                           <table>
                                                            ...
                                                            <v:fill src="https://respectfully-dev-assets.s3.us-west-2.amazonaws.com/user-profile/314/91873bb6a0516bcdc35004460002e3bf.jpg" type="frame">
                                                            <v:/fill>
                                                            </v:oval>
                                                            </td>
                                                            <td width="20%"></td>
                                                    ...
                                                    <td dir="ltr" valign="top"
                                                        style="font-family: 'Montserrat', 'Verdana', sans-serif; font-size: 15px; "
                                                        class="center-on-narrow">
                                                     
                                                  
                                                            <p  class="center-on-narrow" style="margin-top: 0;margin-bottom: 10px;font-size: 14px;
                                                            font-weight: 600;">Laurie Taylor</p>
                                                            <p style="margin: 0;">
                                                                <img src="{{config('app.url')}}/images/icons/email/4_stars.png"></p>
                                                            <p class="text_review" style="margin: 0; width: 70%;    font-size: 12px;
                                                            font-weight: 600;
                                                            color: #646361;">Great Tarot reading, this psychic really changed… Great Tarot reading, this psychic really changed… Great Tarot reading, this psychic really changed…</p>
                        ...
                        <tr>
                                    ...
                                    <td>
                                        ...
                                        <table style="margin-top: 50px !important;
                                            margin-bottom: 40px !important;" role="presentation" border="0" cellpadding="0" cellspacing="0"
                                            width="100%">
                                            <tr>
                                                <td dir="ltr" valign="top"
                                                 ...
                                                 href="{{config('app.url')}}/dashboard/reviews/" target="blank">Check Review</a>
                                                <!--<![endif]--> 
                                                <!--[if gte mso 9]>
                                                <table width="100%"><tr height="10"></tr></table>
                                                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{config('app.url')}}/dashboard/reviews/" style="height:38px;v-text-anchor:middle;width:145px;" arcsize="60%" opacity="0" stroke="f" fillcolor="#9daff9">
                                                <w:anchorlock/>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                <tr>
                                    <td
                                        ...
                                        <h2
                                            style= "text-align: center; margin: 0 0 10px; font-size: 20px; line-height: 30px; color: #8EBEF8; font-weight: normal;font-family: 'Montserrat', 'Verdana', sans-serif;">
                                            Your Review Milestones</h2>
                                        <p style="text-align: center; margin: 0 0 0;font-family: 'Montserrat', 'Verdana', sans-serif;">
                                                Become a master of client happiness.
                                              </p>
                                               <p style="text-align: center; margin: 0 0 10px;font-family: 'Montserrat', 'Verdana', sans-serif;">
                                                   
                                                   Keep those reviews coming to reach your next milestone.</p>
                ...
                <tr>
                  ...
                  <tr>
                    <td dir="ltr" valign="top"
                      ...
                      <a href="https://www.facebook.com/Respectfully/" target="blank" style="margin-left:8px;">
        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600"
            ...
            <tr>
                <td
                    style="font-family: 'Montserrat', 'Verdana', sans-serif;padding: 20px; font-size: 12px; line-height: 15px; text-align: center; color: #C5C5CB!important;">
                    <span style="color:#929394;">This email was sent to {{$user->email}} because you joined our platform.    
                    <br><br>
                    © 2020 Respectfully™. Respectfully™ is a federally registered trademark.</span>
                </td>
            </tr>
        </table>
        <!-- Email Footer : END -->
