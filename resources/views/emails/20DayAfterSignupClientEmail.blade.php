  ...
  <center role="article" aria-roledescription="email" lang="en" style="width: 100%;">
    ...
    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="750"
      ...
      <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" 
        ...
        <v:fill type="tile" src="{{config('app.url')}}/images/site-images/20_day_abilities_triggered_email.png" color="#333333" />   
        <v:textbox inset="0,0,0,0">                                 
      <![endif]-->
        <td class="padding-sm"
          style="height: 229px;;background:#F0F0F7;text-align: center; color: #43425D;font-family: sans-serif; font-size: 15px;margin: auto; display: block;
          background-size: cover; background-repeat: no-repeat; position: relative; background-position: center; background-image: url('{{config('app.url')}}/images/site-images/20_day_abilities_triggered_email.png')">
          <!--[if gte mso 9]>
        <table width="100%">
         <tr height="50"></tr>
        </table>
      ...
      <tr>
        <td
          style="height: 44px; padding-top: 20px;background:#43425D;text-align: center; color: #FFFFFF;font-family: 'Montserrat',  'Verdana', sans-serif; font-size: 15px; margin: auto; display: block;">
          ...
          <div
            ...
            <div style="font-family: 'Montserrat', 'Verdana', sans-serif; ">How to Be a Super Attractor</div>
          </div>
        </td>
      </tr>
      <tr>
        <td
          style="padding-top: 20px; background:#43425D;text-align: center; color: #FFFFFF;font-family: 'Montserrat',  'Verdana', sans-serif; font-size: 15px; margin: auto; display: block; padding-bottom: 20px">

          <div
            style="line-height: 1.5; font-weight: 500;   margin:auto; text-align: center; font-family: 'Montserrat',  'Verdana', sans-serif; font-size: 16px; color:#FFFFFF; text-align: center;max-width: 550px; padding: 10px 15px">
            We all have that friend who never stays single for more than a week, while we’re riding solo trying to
            manifest love out of thin air. That friend is a Super Attractor, but the rest of us need a tour guide to
            find love. Start with a supportive chat to your Model, soak up the positive vibes and relationships will
            fall in your lap!
          </div>
        </td>
      </tr>
      <tr>
        <td
          ...
          <div
            ...
            Our Top Relationship Model Picks
          </div>
        </td>
      </tr>
      @foreach ($users as $user1)
      @php
      $review = $user1->reviews()->where('status', 'posted')->orderBy('rating', 'desc')->first();
      $reviews = $user1->reviews()->where('status', 'posted')->count();
      @endphp
      <tr>
        <td class="padding-sm"
