                        ...
                        <tr>
                            <td class="padding_0"
                                ...
                                <a style="display: inline;">
                                    ...
                                    <v:fill src="{{$appointment->user()->first()->UserProfile()->first()->haedshot_path}}" type="frame">
                                    <v:/fill>
                                    </v:oval>
                                    </td>
                                    <td width="10%"></td>
                                    ...
                                    <!--[if !gte mso 9]> -->
                                        ...
                                        "  src="{{$appointment->user()->first()->UserProfile()->first()->haedshot_path}}"> 
                                        <!--<![endif]-->
                            </a>
                            ...
                            <h4 style="display: inline;">  <p style="display: table-cell;color: #9daff9;    font-size: 15px;">{{$appointment->user()->first()->UserProfile()->first()->name}}</p>
                                        ...
                                        <table style="margin-top: 40px !important;"
                                            ...
                                            <tr>
                                                ...
                                                <!--[if !gte mso 9]> -->
                                                 ...
                                                 href="{{config('app.url')}}/dashboard?r={{$appointment->user_1_1_chat_request->id}}" target="blank">Begin Reading</a>
                                                <!--<![endif]-->  
                                                <!--[if gte mso 9]>
                                                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{config('app.url')}}/dashboard?r={{$appointment->user_1_1_chat_request->id}}" style="height:38px;v-text-anchor:middle;width:152px;" arcsize="60%" opacity="0" stroke="f" fillcolor="#9daff9">
                                                <w:anchorlock/>
