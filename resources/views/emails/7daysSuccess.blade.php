...
<body id="body" width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly;background:#f0f0f7; ">
    ...
    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="750"
      ...
      <tr>
        <td class="padding-sm" 
          ...
          <div
            ...
            <div style="color:#8EBEF8;font-family: 'Montserrat', 'Verdana', sans-serif;font-weight:600:font-size:18px;">Spiritual Success Hacks</div>            
          </div>
        </td>
      </tr>
      ...
      <tr>
        <td class="padding-sm" style="text-align:center;">
            <span style="color: #43425D; font-size: 14px; font-weight: 600;font-family: 'Montserrat', 'Verdana', sans-serif;">Our Top Tips for a Big First Impression</span>
       </td>      
     </tr>
      @for ($i = 0; $i < count($texts); $i++) <tr>
          ...
          <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
            ...
            <tr>
                ...
                <!--[if gte mso 9]>
                  <table width="100%">
                    <tr><td width="20%"></td>
                      <td width="60%">
                     <![endif]-->
                     <img src="{{config('app.url')}}/images/icons/7days/{{$images[$i]}}t.png"
              ...
              <td class="content-right" style="background-color: #EFF6FF;padding: 20px">
                ...
                <div style="font-size: 14px; line-height: 21px; margin-top:10px;; padding: 0px 0px;font-family: 'Montserrat', 'Verdana', sans-serif;min-height:90px;">
                  {{$texts[$i]}}
                </div>
              </td>
            </tr>
        ...
        <tr>
          ...
          <td>
            ...
            <div style="height: 30px; background:#FFFFFF; width: 100%;text-align:center;"><a style="font-weight: 600; width: 83px; height: 30px; padding: 10px 20px; background-color: #8EBEF8; border-radius: 20px; color:#FFFFFF; font-size: 12px;font-family: 'Montserrat', 'Verdana', sans-serif;"
           href="{{config('app.url')}}/{{$user->userProfile->profile_link}}" target="blank">
           <span style="color:#FFFFFF;font-family: 'Montserrat', 'Verdana', sans-serif;">Review Mine</span>
           </a></div>
           <div style="height: 20px; background:#FFFFFF; width: 100%;"></div>
          </td>
            <!--<![endif]-->
              <!--[if gte mso 9]>    
                <td style="text-align:center;"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word"  href="{{config('app.url')}}/{{$user->userProfile->profile_link}}"  style="height:35px;v-text-anchor:middle;width:119px;" arcsize="60%" opacity="0" stroke="f" fillcolor="#8EBEF8">
                 <w:anchorlock/>
              ...
              <table width="100%">               
               <tr style="background:#8EBEF8;" height="15"></tr>
                ...
                <td style="font-weight: 600;background:#8EBEF8;text-align:center;color:#FFFFFF;font-family: 'Montserrat', 'Verdana', sans-serif;">
                  <a style="color:#FFFFFF;">Tap Here to Visit Our Help Center for TipsXXXX!</a>            
                </td>
                </tr>
              <tr style="background:#8EBEF8;" height="15"></tr>
              </tr>
            ...
            <table cellspacing="0" width="100%">
              ...
              <tr>
                ...
                <div style="font-family: 'Montserrat',  'Verdana', sans-serif;">
                  Check out our <a style=" color: #8EBEF8 !important;font-family: 'Montserrat',  'Verdana', sans-serif;"
