        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: auto;" class="email-container">
            ...
            <tr>
                <td style="padding: 20px 0; text-align: center">
                    <img src="{{config('app.url')}}/images/site-images/logo_color.png" width="159" alt="alt_text" border="0"
            ...
            <tr>
                <td style="padding: 20px 0; text-align: center">
                    <h1 style="margin: 0 0 10px; font-size: 32px; line-height: 30px; color: #9759FF; font-weight: normal;text-align: center">
                        Please Rate Your Reading
                    </h1>
                </td>
            </tr>
            <!-- Email Header : END -->
                        ...
                        <tr>
                            <td
                                ...
                                <h2
                                    ...
                                    Hi {{ $appointment->user()->first()->UserProfile()->first()->name }},</h2>
                                <p style="margin: 0 0 10px;font-family: 'Montserrat', 'Verdana', sans-serif; text-align: center;">
                                    Take a moment to reflect on your experience and share a quick review with the spiritual community.</p>
                                    <p style="margin: 0 0 10px;font-family: 'Montserrat', 'Verdana', sans-serif; text-align: center;">
                                        Your review will be posted publicly to {{ $appointment->psychic()->first()->UserProfile()->first()->display_name  }}’s profile. 
                                    </p>
                            </td>
                        </tr>
                                            ...
                                            <table style="margin-top: 40px !important;"
                                                ...
                                                <tr>
                                                    <td dir="ltr" valign="top"
                                                        ...
                                                        font-weight: 600;color:#2d2d2d;text-align: center">{{ $appointment->psychic()->first()->UserProfile()->first()->display_name }}</p>
                                        ...
                                        <table style="margin-top: 50px !important;
                                            ...
                                            <tr>
                                                <td dir="ltr" valign="top"
                                                 ...
                                                 href="{{ config('app.url') }}/review/{{$appointment->token_review}}/{{ $appointment->id }}" target="blank">Review Now</a>
                                                <!--<![endif]-->  
                                                <!--[if gte mso 9]>
                                                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ config('app.url') }}/review/{{$appointment->token_review}}/{{ $appointment->id }}" style="height:38px;v-text-anchor:middle;width:197px;" arcsize="60%" opacity="0" stroke="f" fillcolor="#9daff9">
                                                <w:anchorlock/>
                          ...
                          <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            ...
                            <tr>
                              <td
                                ...
                                <p style="color:#C7C7C7;text-align: center;">This email was sent to {{$appointment->user()->first()->email}} because you joined our platform.
                                <br><br>
