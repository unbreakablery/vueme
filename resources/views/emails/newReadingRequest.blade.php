            ...
            <tr>
                <td dir="ltr" width="100%" style="padding: 10px; background-color: #EFF6FF;">
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            {{$appointment->user()->first()->UserProfile()->first()->name}} wants to {{$appointment->service()->first()->name}} you
                                        ...
                                        <table 
                                            ...
                                            <tr>
                                                <td dir="ltr" valign="top"
                                                 ...
                                                 href="{{config('app.url')}}/dashboard?r={{$appointment->id}}" target="blank">Begin Reading</a>
                                                <!--<![endif]-->  
                                                <!--[if gte mso 9]>
                                                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{config('app.url')}}/dashboard?r={{$appointment->id}}" style="height:38px;v-text-anchor:middle;width:152px;" arcsize="60%" opacity="0" stroke="f" fillcolor="#9daff9">
                                                <w:anchorlock/>
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    ...
                    <tr>
                      <td
                        ...
                        <p style="color:#C7C7C7;text-align: center;">This email was sent to {{$appointment->model()->first()->email}} because you joined our platform as a psychic.
                        <br><br>
