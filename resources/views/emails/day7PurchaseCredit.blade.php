      ...
      <tr>
        <td
          ...
          <div
            ...
            With nearly 2,000 Models to choose from, discover your Spiritual match for less! Just add some funds to your digital wallet and we’ll drop an extra $5 in your account for peace of mind wherever you go.
          </div>
        </td>
      </tr>
      <tr>
        <td style="text-align: center; background-color: #EFF6FF; padding-bottom: 50px; padding-top: 20px;width: 100%;">
          <div style="width: 100%;">
            <img src="{{config('app.url')}}/images/site-images/5_free_credit_email.png" width="375" height="200" style="max-width: 100%;"/>
          </div>

          <div style="padding-top: 40px">
            <!--[if !gte mso 9]> -->
            <a style="font-weight: 600; width: 114px; height: 38px; padding: 10px 20px; background-color: #9759FF; border-radius: 20px; color:white; font-size: 14px;font-family: 'Montserrat', 'Verdana', sans-serif;"
            ...
            <!--[endif]-->
                ...
                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{config('app.url')}}" style="height:38px;v-text-anchor:middle;width:114px;" arcsize="60%" opacity="0" stroke="f" fillcolor="#9759FF">
                <w:anchorlock/>
