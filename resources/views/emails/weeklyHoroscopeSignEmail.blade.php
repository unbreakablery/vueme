    ...
    <center role="article" aria-roledescription="email" lang="en" style="width: 100%;">
        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="750"
            ...
            <tr>
                <td>
                    <div class="hidden-sm"
                        style="width: 100%; height: 180px; background-size: cover; background-repeat: no-repeat; background-image: url('https://www.respectfully.com/images/site-images/home-hero-image.png'); text-align: center;">
                        <div style="margin-bottom: 40px;padding-top: 40px">
                            <a href="https://www.respectfully.com/">
                                <img src="https://www.respectfully.com/images/site-images/logo.png" width="159" />
                            </a>
                        </div>
                        ...
                        <div
                            ...
                            Find Your Weekly Destiny
                        </div>
                    </div>
                    <div class="show-sm"
                        style="width: 100%; height: 180px; background-size: cover; background-repeat: no-repeat; background-image: url('https://www.respectfully.com/images/site-images/home-hero-image-mobile.png'); text-align: center;">
                        <div style="margin-bottom: 40px;padding-top: 40px">
                            <a href="https://www.respectfully.com/">
                                <img src="https://www.respectfully.com/images/site-images/logo.png" width="159" />
                            </a>
                ...
                <td
                    ...
                    <div
                        ...
                        <div class="font-change"
                            ...
                            Your Weekly Horoscope is Ready
                        </div>
                    </div>
                </td>
            </tr>
            ...
            <tr>
                ...
                style="line-height: 24px; text-align: center; padding:30px 20px; margin: auto; background: #FFFFFF;">
                    ...
                    <table  class="hidden-sm"  cellspacing="0" cellpadding="0" border="0" style="margin: auto;">        
                      <tr>
                        <td>
                            <a href="https://www.respectfully.com/horoscope/{{$signs['url']}}">
                                <img src="https://www.respectfully.com/images/horoscopes/{{$signs['url']}}.png" width="118" />
                            </a>
                        </td>
                        <td>
                        <div
                            style="font-family: 'Montserrat', 'Verdana', sans-serif; padding-left: 30px;letter-spacing: 0.36px; max-width: 550px;     text-align: left; font-size: 18px; font-weight: 600;color:#43425D;  ">
                            {{$signs['name']}}
                        </div>

                        <div
                            style="font-family: 'Montserrat', 'Verdana', sans-serif; padding-left: 30px;letter-spacing: 0.36px; max-width: 550px;     text-align: left; font-size: 12px; font-weight: 500;color:#43425D; margin-top: 15px ">
                            {{$signs['date']}}
                        </div>
                    ...
                    <table  class="show-sm"  cellspacing="0" cellpadding="0" border="0" style="margin: auto;">        
                      <tr>
                        <td style="text-align: center; ">
                        <div
                            style="font-family: 'Montserrat', 'Verdana', sans-serif; letter-spacing: 0.36px; max-width: 550px;     text-align: center; font-size: 18px; font-weight: 600;color:#43425D;  ">
                            {{$signs['name']}}
                        </div>

                        <div
                            style="font-family: 'Montserrat', 'Verdana', sans-serif; letter-spacing: 0.36px; max-width: 550px;     text-align: center; font-size: 12px; font-weight: 500;color:#43425D; margin-top: 15px ">
                            {{$signs['date']}}
                        </div>
                        ...
                        <div style=" margin-top: 30px; height: 30px; width: 100%;text-align:center;"><a
                            ...
                            href="https://www.respectfully.com/horoscope/{{$signs['url']}}"
                            target="blank">
                            <span style="color:#FFFFFF; font-family: 'Montserrat', 'Verdana', sans-serif;">View Now</span>
                        </a></div>
                                        ...
                                        <tr>
                                            <td style="font-family: 'Montserrat', 'Verdana', sans-serif; font-size: 15px; color:#ffffff; text-align: center; "
                                                ...
                                                <a href="https://www.instagram.com/respectfully/" target="blank">
                                                    <img src="https://www.respectfully.com/images/icons/email/instagram_2.png">
                                                </a>
                                                <a href="https://www.facebook.com/Respectfully/" target="blank"
                                                    style="margin-left:14px;">
                                                    <img src="https://www.respectfully.com/images/icons/email/facebook_2.png">

                                                </a>
                                                <a href="https://twitter.com/respectfully/" target="blank"
                                                    style="margin-left:14px;">
                                                    <img class="padding_social"
                                                        src="https://www.respectfully.com/images/icons/email/twitter_2.png">
                                                </a>
                                                <a href="https://www.linkedin.com/company/respectfully/about/"
                                                    target="blank" style="margin-left:14px;">
                                                    <img src="https://www.respectfully.com/images/icons/email/linkedin_2.png">
                                                </a>
