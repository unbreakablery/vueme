...
<body width="100%"
    ...
    <center style="width: 100%; background-color: #ffffff;">
        <!--[if mso | IE]>
    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #eff6ff;">
        <tr>
            <td>
    <![endif]-->
        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600"
            ...
            <!-- Email Header : BEGIN -->
            <tr>
                <td style="padding: 20px 0; text-align: center;background-color: #eff6ff;">
                    <img src="{{config('app.url')}}/images/site-images/logo_color.png" width="159"
                        alt="alt_text" border="0"
                        style="height: auto; background: #eff6ff; font-family: sans-serif; font-size: 15px; line-height: 15px; color: #555555;">
                </td>
            </tr>
            ...
            <tr>
                <td style="padding: 20px 0; text-align: center;background-color: #eff6ff;">
                    <h1
                        style="text-align:center; margin: 0 0 10px; font-size: 32px; line-height: 30px; color: #9759FF; font-weight: normal;font-family: 'Montserrat', 'Verdana', sans-serif;">
                        Hola {{$user->UserProfile()->first()->name}}</h1>
                </td>
            </tr>
            <!-- Email Header : END -->
            ...
            <tr>
                <td style="background-color: #eff6ff;">
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                            <td
                                style="padding: 20px;font-family: 'Montserrat',
                                ...
                                <p style="margin: 0 0 10px;font-family: 'Montserrat', 'Verdana', sans-serif; text-align: center;">
                                    Are you comfortable giving readings in Spanish? If so we want to hear from you!</p>
                                    ...
                                    <td>
                                        ...
                                        <table style="margin-top: 50px !important;
                                            ...
                                            <tr>
                                                ...
                                                <!--[if !gte mso 9]> -->
                                                 <a style="padding: 10px 50px; font-weight: bold;
                                                 background-color: #8fbef8;
                                                 border-radius: 20px; color:white;"
                                                 href="https://docs.google.com/forms/d/e/1FAIpQLSd1ZOLjYfHupjijo4FIKcj_dCVHCDvWTg6sO7waC21Znnc3Bg/viewform" target="blank">Complete Survey</a>
                                                 <!--<![endif]--> 
                                                 <!--[if gte mso 9]>
                                                <table width="100%"><tr height="10"></tr></table>
                                                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://docs.google.com/forms/d/e/1FAIpQLSd1ZOLjYfHupjijo4FIKcj_dCVHCDvWTg6sO7waC21Znnc3Bg/viewform" style="height:38px;v-text-anchor:middle;width:234px;" arcsize="60%" opacity="0" stroke="f" fillcolor="#8fbef8">
                                                <w:anchorlock/>
        ...
        <center style="width: 100%; background-color: #ffffff;">
            ...
            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600"
                ...
                <tr>
                    <td
                        style="font-family: 'Montserrat', 'Verdana', sans-serif;padding: 20px; font-size: 12px; line-height: 15px; text-align: center; color: #777591!important;">
                        <span style="color:#777591;">This email was sent to {{$user->email}} because you joined our platform as a psychic.
                        <br><br>
