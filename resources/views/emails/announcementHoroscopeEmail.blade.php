    ...
    <center role="article" aria-roledescription="email" lang="en" style="width: 100%;">
        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="750"
            ...
            <tr>
                <td>
                    <div class="hidden-sm"
                        style="width: 100%; height: 236px; background-size: cover; background-repeat: no-repeat; background-image: url('https://www.respectfully.com/images/site-images/bg_horoscope_launched.png'); text-align: center;">
                    ...
                    <div class="show-sm"
                        style="width: 100%; height: 236px; background-size: cover; background-repeat: no-repeat; background-image: url('https://www.respectfully.com/images/site-images/bg_horoscope_launched_mobile.png'); text-align: center;">
                        <div style="margin-bottom: 40px;padding-top: 40px">
                            <a href="https://www.respectfully.com/">
                                <img src="https://www.respectfully.com/images/site-images/logo.png" width="159" />
                            </a>
            ...
            <tr>
                <td
                    ...
                    <div style=" margin-top: 30px; height: 30px; width: 100%;text-align:center;"><a
                            ...
                            href="https://www.respectfully.com/horoscope"
                            target="blank">
