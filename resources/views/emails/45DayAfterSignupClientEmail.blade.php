  ...
  <center role="article" aria-roledescription="email" lang="en" style="width: 100%;">
    ...
    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="750"
      ...
      <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" 
        style="width: 750px; height: 256px;">
        <v:fill type="tile" src="{{config('app.url')}}/images/site-images/45_day_abilities_triggered_email.png" color="#333333" />   
        <v:textbox inset="0,0,0,0">                                 
      <![endif]-->
        <td class="padding-sm"
          style="height: 229px;;background:#F0F0F7;text-align: center; color: #43425D;font-family: 'Montserrat',  'Verdana', sans-serif; font-size: 15px;margin: auto; display: block;
          background-size: cover; background-repeat: no-repeat; position: relative; background-position: center; background-image: url('{{config('app.url')}}/images/site-images/45_day_abilities_triggered_email.png')">
          <!--[if gte mso 9]>
        <table width="100%">
         <tr height="50"></tr>
        </table>
      ...
      <tr>
        <td
          ...
          <div
            ...
            <div style="font-family: 'Montserrat',  'Verdana', sans-serif;font-size:18px;">How Past Lives Heal the Soul</div>
          </div>
        </td>
      </tr>
      <tr>
        <td
          style="padding-top: 7px; background:#43425D;text-align: center; color: #FFFFFF;font-family: 'Montserrat',  'Verdana', sans-serif; font-size: 15px; margin: auto; display: block; padding-bottom: 20px">

          <div
            style="line-height: 1.5; margin:auto; text-align: center; font-family: 'Montserrat',  'Verdana', sans-serif; font-size: 16px; color:#FFFFFF; text-align: center;max-width: 550px; padding: 10px 15px">
            <div style="font-family: 'Montserrat',  'Verdana', sans-serif;font-weight:500;font-size:16px;">We experience multiple versions of reality at the same time, especially during the critical
              decision-making process. Our past lives can leave leftover energy that blocks clarity, but can also help
              us evolve. Mediums help us crack open our own little black book of past lives - for most of us, those are
              buried too deep in our subconscious to find.</div>
          </div>
        </td>
      </tr>
      <tr>
        <td
          style=" background:#F0F0F7;text-align: center; color: #43425D;font-family: 'Montserrat',  'Verdana', sans-serif; font-size: 14px; margin: auto; display: block; padding-top: 20px">

          <div
            style="line-height: 1.5; text-transform: capitalize; margin:auto; text-align: center; font-family: 'Montserrat',  'Verdana', sans-serif; font-size: 16px; color:#43425D; font-weight: 600; text-align: center;max-width: 550px; padding: 10px 15px">
      ...
      @php
      $review = $user1->reviews()->orderBy('rating', 'desc')->first();
      $reviews = $user1->reviews()->count();
      @endphp
      <tr>
        <td class="padding-sm"
          style=" height: 115px; background:#F0F0F7;text-align: center; color: #43425D;font-family: 'Montserrat',  'Verdana', sans-serif;font-size: 15px; line-height: 15px; margin: auto;">
          <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
            height="100%">
            <tr>
              <td class="content-left hidden-sm"
                style="background: #D8E4F7; vertical-align: top; padding-top: 20px; padding-bottom: 15px">
                <!--[if gte mso 9]>
                <table>
                  <tr>
                    <td width="20%"></td>
                    ...
                    <![endif]-->
                <!--[if !gte mso 9]> -->
                {{-- <img src="{{$user->userProfile->haedshot_path}}" width="95" height="95" style="border-radius: 50%;" /> --}}
        ...
        background-size: cover; border-radius: 50%; display: inline; display: inline-block"></div>
              ...
              <td class="content-right"
                ...
                <div
                  ...
                  <div style="padding-right: 10px; float: left;" class="show-sm">
                    {{-- <img src="{{$user->userProfile->haedshot_path}}"
              ...
              background-size: cover; border-radius: 50%; display: inline; display: inline-block"></div>
                ...
                <div
                  ...
                  {{$user1->userProfile->elevator_pitch ?? $user1->userProfile->tagline ?? (strlen($user1->user_profile->description) < 160 ? $user1->user_profile->description : substr($user1->user_profile->description, 0, 160) . '...')}}
                </div>
            ...
            <table cellspacing="0" width="100%">
              <tr>
                <td
                  ...
                  <div class="hidden-sm">Read the Latest Model News on Our Radar</div>
                  <div class="show-sm">
                    ...
                    <tr>
                      <td
                        ...
                        © Copyright 2020 <a target="_blank" href="VueMe.com"><span
                            style="color:#8EBEF8"><span style="font-family: 'Montserrat',  'Verdana', sans-serif; ">VueMe.</span>com</span></a>, LLC</span>
                      </td>
                    </tr>
                  </table>
                </td>
