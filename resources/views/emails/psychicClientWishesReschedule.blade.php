            ...
            <tr>
                <td style="padding: 20px 0; text-align: center">
                    <h1
                        ...
                        Your Client Wishes To Reschedule</h1>
                </td>
            </tr>
            <!-- Email Header : END -->
                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                            <td class="padding_0"
                                ...
                                'Verdana', sans-serif; font-size: 14px; line-height: 20px; color: #929394;text-align: right; width: 43%;">
                                <a style="display: inline;">
                                    ...
                                    <v:fill src="{{$new_appointment->user()->first()->UserProfile()->first()->haedshot_path}}" type="frame">
                                    <v:/fill>
                                    </v:oval>
                                    </td>
                                    <td width="10%"></td>
                                    ...
                                    <!--[if !gte mso 9]> -->
                                        ...
                                        "  src="{{$new_appointment->user()->first()->UserProfile()->first()->haedshot_path}}"> 
                                        <!--<![endif]-->
                                        </a>
                            ...
                            'Verdana', sans-serif; font-size: 14px; line-height: 20px; color: #929394;display: flex;">
                           
                            <h4 style="display: inline;">  <p style="display: table-cell;color:black;    font-size: 15px;">{{$new_appointment->user()->first()->UserProfile()->first()->name}}</p>
                            </h4>
                                        ...
                                        <table
                                            ...
                                            <tr>
                                                <td dir="ltr" valign="top"
                                                    style="font-family: 'Montserrat', 'Verdana', sans-serif; font-size: 15px;color: #a5b6ff;
                                                    font-weight: bold;
                                                    font-size: 20px;text-align: center; "
                                                    class="center-on-narrow">
                                                 
                                               <p style="text-align: center;color: #a5b6ff">Reschedule To:</p>
                                ...
                                <table class="with_mobile_txt" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                            <td dir="ltr" valign="top" style="font-family: 'Montserrat', 'Verdana', sans-serif; font-size: 15px; line-height: 20px; color: #555555; padding: 10px; text-align: center;" class="center-on-narrow">
                                                    ...
                                                    color: #a27eb5;    margin-top: 0;">Service</p>
                                                    <p style="    background-color: #FFFFFF;
    padding: 7px;
    border-radius: 5px;
    font-weight: 600;
    color: #8b8b8b;">{{$new_appointment->service()->first()->name}}</p>
                            ...
                            <td class="stack-column-center">
                                <table class="with_mobile_txt" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td  dir="ltr" valign="top" style="font-family: 'Montserrat', 'Verdana', sans-serif; font-size: 15px; line-height: 20px; color: #555555; padding: 10px; text-align: center;" class="center-on-narrow">
                                                <p style="font-weight: 600;
                                                color: #a27eb5;    margin-top: 0;">Date</p>
                                                <p style="    background-color: #FFFFFF;
                                                padding: 7px;
                                                border-radius: 5px;
                                                font-weight: 600;
                                                color: #8b8b8b;">{{ $new_appointment->start_hour}}</p>
                             ...
                             <td class="stack-column-center">
                                    <table class="with_mobile_txt" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td dir="ltr" valign="top" style="font-family: 'Montserrat', 'Verdana', sans-serif; font-size: 15px; line-height: 20px; color: #555555; padding: 10px; text-align: center;" class="center-on-narrow">
                                                    <p style="font-weight: 600;
                                                    color: #a27eb5;    margin-top: 0;">Duration</p>
                                                    <p style="    background-color: #FFFFFF;
                                                    padding: 7px;
                                                    border-radius: 5px;
                                                    font-weight: 600;
                                                    color: #8b8b8b;"> {{ $new_appointment->duration}}
                                                  @if($new_appointment->duration == 1)         
                                                     Minute          
                                                    @else
                                                      Minutes      
                                                    @endif    </p>
            ...
            <tr>
                    ...
                    margin-bottom: 30px !important;"
                        ...
                        <tr>
                            <td dir="ltr" valign="top"
                             ...
                             href="{{config('app.url')}}/dashboard/" target="blank">Manage Request</a>
                             <!--<![endif]-->  
                             <!--[if gte mso 9]>
                             <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{config('app.url')}}/dashboard/" style="height:38px;v-text-anchor:middle;width:168px;" arcsize="60%" opacity="0" stroke="f" fillcolor="#9daff9">
                             <w:anchorlock/>
             ...
             <!-- Thumbnail Left, Text Right : BEGIN -->
             <tr>
                <td dir="ltr" width="100%" style="padding: 10px; background-color:#eae8e8;">
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                                    ...
                                    <td>
                                        ...
                                        <table 
                                            ...
                                            <tr>
                                                <td dir="ltr" valign="top"
                                                    style="font-family: 'Montserrat', 'Verdana', sans-serif; font-size: 15px;color: #c2c3c6;
                                                    font-weight: bold;
                                                    font-size: 20px;text-align: center; "
                                                    class="center-on-narrow">
                                                 
                                               <p style="text-align: center;color: #c2c3c6;">Original Appointment:</p>
                            ...
                            <td class="stack-column-center">
                                <table class="with_mobile_txt" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                            <td dir="ltr" valign="top" style="font-family: 'Montserrat', 'Verdana', sans-serif; font-size: 15px; line-height: 20px; color: #555555; padding: 10px; text-align: center;" class="center-on-narrow">
                                                    <p style="font-weight: 600;
                                                    color: #c2c3c6; margin-top: 0;">Service</p>
                                                    <p style="    background-color: #cdcccc;
    padding: 7px;
    border-radius: 5px;
    font-weight: 600;
    color: #8b8b8b;">{{$old_appointment->service()->first()->name}}</p>
                            ...
                            <td class="stack-column-center">
                                <table class="with_mobile_txt" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td dir="ltr" valign="top" style="font-family: 'Montserrat', 'Verdana', sans-serif; font-size: 15px; line-height: 20px; color: #555555; padding: 10px; text-align: center;" class="center-on-narrow">
                                                <p style="font-weight: 600;
                                                color: #c2c3c6; margin-top: 0;">Date</p>
                                                <p style="    background-color: #cdcccc;
                                                padding: 7px;
                                                border-radius: 5px;
                                                font-weight: 600;
                                                color: #8b8b8b;">{{ $old_appointment->start_hour}}</p>
                             ...
                             <td class="stack-column-center">
                                    <table class="with_mobile_txt" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td dir="ltr" valign="top" style="font-family: 'Montserrat', 'Verdana', sans-serif; font-size: 15px; line-height: 20px; color: #555555; padding: 10px; text-align: center;" class="center-on-narrow">
                                                    <p style="font-weight: 600;
                                                    color: #c2c3c6; margin-top: 0;">Duration</p>
                                                    <p style="    background-color: #cdcccc;
                                                    padding: 7px;
                                                    border-radius: 5px;
                                                    font-weight: 600;
                                                    color: #8b8b8b;">{{ $old_appointment->duration}}
                                                  @if($old_appointment->duration == 1)         
                                                     Minute          
                                                    @else
                                                      Minutes      
                                                    @endif    </p>
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    ...
                    <tr>
                      <td
                        ...
                        <p style="color:#C7C7C7;text-align: center;">This email was sent to {{$old_appointment->psychic()->first()->email}} because you joined our platform as a psychic.
                        <br><br>
