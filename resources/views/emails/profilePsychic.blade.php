...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; ">
    ...
    <center role="article" aria-roledescription="email" lang="en" style="width: 100%;">
        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="750"
            style="margin: auto; background: #F0F0F7;" class="email-container">
            <tr>
                <td style="padding: 40px 0px; font-family: 'Montserrat',  'Verdana', sans-serif; font-size: 15px; color:white; text-align: center; "
            ...
            <tr>
                <td
                    style="text-align: center; font-family: 'Montserrat',  'Verdana', sans-serif; font-weight: 600; font-size: 18px; color: #9D61BD;">
                    Your New Profile Page Is Live!
                </td>
            </tr>
            <tr>
                <td
                    style="line-height: 24px; text-align: center; padding:30px 20px 20px 20px; margin: auto; font-family: 'Montserrat',  'Verdana', sans-serif; color: #43425D;font-size: 16px;">
                    <div
                        style="max-width: 550px; margin: auto; font-family: 'Montserrat',  'Verdana', sans-serif;">
                        We just launched a new profile page to make it even easier for clients to book appointments with
                        you! Please update your profile details now to ensure your new page looks complete to new and
                        existing clients.
                    </div>
                </td>
            </tr>
            <tr>
                <td
                    style="text-align: center; color: #8EBEF8; font-family: 'Montserrat',  'Verdana', sans-serif; font-weight: 600; font-size: 16px;">
                    <div style="max-width: 590px; width: 100%;margin: auto; padding-top:15px">
                        <img style="margin: auto" width="100%"
                            src="{{config('app.url')}}/images/site-images/profile_email.png" />
                    </div>
                </td>
            </tr>
            <tr>
                <td
                    ...
                    <div style="padding: 40px; 0px">
                        <!--[if !gte mso 9]> -->
                        <a style="font-weight: 600; width: 114px; height: 38px; padding: 10px 20px; background-color: #9759FF; border-radius: 20px; color:white; font-size: 14px; font-weight: 600; font-family: 'Montserrat', 'Verdana', sans-serif;"
                        ...
                        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{config('app.url')}}/dashboard/profile" style="height:38px;v-text-anchor:middle;width:130px;" arcsize="60%" opacity="0" stroke="f" fillcolor="#9759FF">
                        <w:anchorlock/>
