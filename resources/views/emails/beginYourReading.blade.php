        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600"
            ...
            <tr>
                <td style="padding: 20px 0; text-align: center">
                    <img src="{{config('app.url')}}/images/site-images/logo_color.png" width="159" alt="alt_text"
                        border="0"
                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                            <td class="with_mobile_img padding_0"
                                ...
                                'Verdana', sans-serif; font-size: 14px; line-height: 20px; color: #929394;text-align: right; width: 40%;">
                            ...
                            <td class="padding_0" style="padding: 20px 10px;font-family: 'Montserrat', 
                            'Verdana', sans-serif; font-size: 14px; line-height: 20px; color: #929394;display: flex;">

                                <h4 style="display: inline;">
                                    <p style="display: table-cell;color: #9daff9;    font-size: 15px;">
                                        {{$user_chat_request->model()->first()->UserProfile()->first()->display_name}}
                                        Accepted</p>
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <table style="margin-top: 40px !important;" role="presentation" border="0"
                                    ...
                                    <tr>
                                        <td dir="ltr" valign="top"
                                            ...
                                            <a style="padding: 10px 20px;
                                                ...
                                                href="{{config('app.url')}}/dashboard/appointments?r={{$user_chat_request->id}}"
                                                target="blank">Begin Reading</a>
                                            <!--<![endif]-->
                                            <!--[if gte mso 9]>
                                                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{config('app.url')}}/dashboard/appointments?r={{$user_chat_request->id}}" style="height:38px;v-text-anchor:middle;width:152px;" arcsize="60%" opacity="0" stroke="f" fillcolor="#9daff9">
                                                <w:anchorlock/>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <table style="margin-top: 50px !important;
                                                margin-bottom: 10px !important;" role="presentation" border="0"
                                    cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td dir="ltr" valign="top"
                                            style="font-family: 'Montserrat', 'Verdana', sans-serif; font-size: 15px; color:white;      text-align: center; "
                                            ...
                                            <img src="{{config('app.url')}}/images/icons/email/reader.png">
            ...
            <tr>
                <td dir="ltr" width="100%" style="padding: 10px;">
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                            <td>
                                <table style="margin-top: 50px !important;" role="presentation" border="0"
                                    cellpadding="0" cellspacing="0" width="100%">
                                    <!--[if !gte mso 9]> -->
                                    <tr>
                                        <td dir="ltr" valign="top"
                                            ...
                                            <a href="https://www.facebook.com/Respectfully/" target="blank"
                                                class="ml-45" style="margin-left:10px;">
                                            ...
                                            <a href="https://twitter.com/respectfully/" target="blank" class="ml-45">
                                                <img class="padding_social"
                                                    src="{{config('app.url')}}/images/icons/email/twitter2.png">
                                            </a>
                                            <a href="https://www.linkedin.com/company/respectfully/about/"
                                                target="blank" class="ml-45">
                                                <img src="{{config('app.url')}}/images/icons/email/linkedin2.png">
                                            </a>
                                            <div
                                                style="width:50%; border-top: 1px solid #C7C7C7; margin: auto; margin-top: 20px;">
                                            </div>
                                        </td>
                                    </tr>
                                    <!--[endif]-->
                    ...
                    <![endif]-->
                        <tr>
                            <td
                                ...
                                <p style="color:#C7C7C7;text-align: center;">This email was sent to
                                    {{$user_chat_request->user()->first()->email}} because you joined our platform.
                                    <br><br>
